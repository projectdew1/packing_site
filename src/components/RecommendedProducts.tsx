      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/shop" className="inline-flex items-center gap-2 text-blue-300 hover:text-white font-semibold transition-colors">
        ...
        >
          {RECOMMENDED_PRODUCTS.map((product, idx) => (
            <SwiperSlide key={idx} className="!h-auto">
              {/* Wrapped entire card in Link to make it fully clickable */}
              <Link 
                href="/contact" 
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow relative">
                  ...
                  <h4 
                    className="font-bold text-lg mb-5 line-clamp-2 leading-[1.3] text-slate-200 group-hover:text-blue-200 transition-colors drop-shadow-sm"
                    title={product.title}
                  >
                    {product.title}
                  </h4>
                  
                  {/* Button changed to span since card is already a Link */}
